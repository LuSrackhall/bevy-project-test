...
- [x] 7.3 手动验证：主菜单不启动仿真，点击"单人模式"后游戏正常开始
- [x] 7.4 手动验证：游戏结束后"再来一局"能正确重开新游戏（经 MainMenu 中转）
- [x] 7.5 手动验证：暂停/继续功能正常（Esc 立即暂停，继续按钮恢复）
- [x] 7.6 手动验证：暂停中"重新开始"能正确重开新游戏（经 MainMenu 中转）
