...
whenToUse: Use when archiving several parallel changes.
metadata:
  author: openspec
  version: '1.0'
  generatedBy: 1.4.1
...
2. **Prompt for change selection**
   ...
   Use **ask_user_question tool** with multi-select to let user choose changes:
...
7. **Confirm batch operation**
   ...
   Use **ask_user_question tool** with a single confirmation:
