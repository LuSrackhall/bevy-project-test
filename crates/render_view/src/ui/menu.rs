...
pub fn setup_main_menu(mut commands: Commands, asset_server: Res<AssetServer>) {
    ...
    .with_children(|parent| {
        ...
        parent.spawn((WidgetButton, Node { margin: UiRect::all(Val::Px(10.0)), padding: UiRect::all(Val::Px(20.0)), border: UiRect::all(Val::Px(2.0)), ..default() }, MenuButton::SinglePlayer, ButtonTheme::default(), Hovered::default(), BorderColor::all(Color::srgba(0.35, 0.35, 0.40, 1.0))))
            .with_child((Text::new("单人模式"), TextFont { font: font.clone(), font_size: 24.0, ..default() }))
            .observe(|_ev: On<Activate>, mut next: ResMut<NextState<crate::GameState>>, mut needs_reset: ResMut<crate::NeedsGameReset>| {
                needs_reset.0 = true;
