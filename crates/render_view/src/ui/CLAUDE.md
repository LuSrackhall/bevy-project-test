...
- Use official widgets and composable UI primitives as the behavioral foundation.
...
- React to semantic UI events and/or reactive updates instead of polling visual state.
...
When Bevy evolves (input system, UI architecture, declarative UI system, ECS relations, or UI execution model), preserve these architectural principles instead of preserving specific APIs or implementation patterns.
